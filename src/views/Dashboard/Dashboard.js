  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="6" lg="3">
            <MetricSummary name="Water flow" unit="L/hr" date={new Date(2017, 4, 11)} currentValue={43} average={74}
                           threshold={(value) => value > 20} thresholdText={"> 20"} />
          </Col>
          <Col xs="12" sm="6" lg="3">
            <MetricSummary name="Turbidity" unit={"%"} date={new Date(2017, 8, 17)} currentValue={65} average={32}
